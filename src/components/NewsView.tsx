    ...
    <div className="col-span-12 space-y-8" id="news-view-container">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2.5 border-b border-slate-800 pb-3">
          ...
          <div>
            <h3 className="text-sm font-black text-slate-100">07:50 장전 브리핑</h3>
            <p className="text-[10px] text-slate-500 font-bold font-mono">MORNING GLOBAL MARKET BRIEFING</p>
          </div>
        </div>
        <BriefingView
          briefing={briefing}
      ...
      <div className="space-y-3">
        ...
        {lunchLoading ? (
          <div className="bg-slate-900 border border-slate-800 rounded-2xl flex flex-col items-center justify-center py-20 space-y-3">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 md:p-6 space-y-5 text-xs text-slate-300 leading-relaxed">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl text-center py-16 text-slate-500 text-xs font-mono">
            데이터를 불러오는 중입니다...
          </div>
        )}
      </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2.5 border-b border-slate-800 pb-3">
          ...
          <div>
            <h3 className="text-sm font-black text-slate-100">16:00 장마감 브리핑</h3>
            <p className="text-[10px] text-slate-500 font-bold font-mono">AFTER-MARKET CLOSING REPORT</p>
          </div>
        </div>
        <ReportView
          report={report}
      ...
      <div className="space-y-3">
        ...
        {eveningLoading ? (
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 md:p-6 space-y-4 text-xs text-slate-300 leading-relaxed">
