    ...
    <div className="col-span-12 space-y-8" id="news-view-container">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2.5 border-b border-slate-200 dark:border-slate-800 pb-3">
          ...
          <div>
            <h3 className="text-sm font-black text-slate-900 dark:text-slate-100">07:40 장전 브리핑</h3>
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2.5 border-b border-slate-200 dark:border-slate-800 pb-3">
          ...
          <div>
            <h3 className="text-sm font-black text-slate-900 dark:text-slate-100">15:50 장마감 브리핑</h3>
