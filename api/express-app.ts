...
CREATE TABLE kstock_platform_data (
  ...
  const MASTER_INSIGHT_TOPICS = [
    ...
    { index: 12, topic: "무네히사 혼마: 세계 최초 캔들차트 및 사카타 오법 개발", cat: "Strategy" },
    { index: 13, topic: "찰스 다우: 다우존스 지수 창시 및 기술적 분석의 뼈대인 '다우 이론' 정립", cat: "Strategy" },
    { index: 14, topic: "리처드 샤바커: 헤드앤숄더 등 차트 패턴 분석을 최초로 체계화", cat: "Strategy" },
    { index: 15, topic: "R.N. 엘리어트: 피보나치 수열 기반의 상승 5파/하락 3파 '엘리어트 파동 이론' 창시", cat: "Strategy" },
    { index: 16, topic: "W.D. 개안: 시간과 가격의 수학적 대칭성을 활용한 개안 각도선 및 기하학 분석", cat: "Strategy" },
    { index: 17, topic: "J. 웨일즈 와일더: RSI, ADX, ATR, Parabolic SAR 등 핵심 보조지표 무더기 개발", cat: "Strategy" },
    { index: 18, topic: "제럴드 아펠: 이동평균선의 수렴과 확산을 이용한 'MACD' 지표 개발", cat: "Strategy" },
    { index: 19, topic: "존 볼린저: 통계학 표준편차를 결합한 '볼린저 밴드' 지표 개발", cat: "Strategy" },
    { index: 20, topic: "조지 레인: 모멘텀과 과매수/과매도를 파악하는 '스토캐스틱' 지표 개발", cat: "Strategy" },
    ...
    { index: 23, topic: "공매도 잔고와 대차잔고 추이로 파악하는 숏커버링 유망 섹터 정량 분석", cat: "SupplyDemand" },
    { index: 24, topic: "미국 관세 정책 불확실성과 글로벌 공급망 재편이 한국 기업에 미치는 영향", cat: "Macro" },
    { index: 25, topic: "옵션만기일(네 마녀의 날) 변동성 생존 규칙과 메이저 포지션 정량 파악법", cat: "Strategy" },
    { index: 26, topic: "신고가 돌파 후 첫 눌림목 매수 전략: 성공률 90% 거래 타점 공식과 피보나치 비율", cat: "Strategy" },
    { index: 27, topic: "니콜라스 다바스: 신고가 돌파 원리를 이용한 박스권 매매법(Darvas Box) 창시", cat: "Strategy" },
    { index: 28, topic: "얀 판 로스하우트: 세계 최초의 주식회사(네덜란드 동인도회사) 및 증권거래소 설립", cat: "History" },
    { index: 29, topic: "존 로: 미시시피 버블을 일으키며 자산 거품과 통화 정책의 연관성을 역사에 각인", cat: "History" },
    { index: 30, topic: "내선 로스차일드: 정보 네트워크를 구축하여 \"정보가 곧 자본\"이라는 불문율 확립", cat: "History" },
    { index: 31, topic: "J.P. 모건: 기업 M&A를 주도하며 월스트리트를 세계 금융의 중심지로 격상", cat: "History" },
    { index: 32, topic: "제롬 파월 및 연준 의장들: 금리와 유동성 공급을 통해 현대 증시의 향방을 지배", cat: "Macro" },
    { index: 33, topic: "벤저민 그레이엄: '가치투자의 아버지', 기업 재무제표 분석법 체계화", cat: "Strategy" },
    { index: 34, topic: "워런 버핏: 복리 효과와 경제적 해자(Moat) 개념을 결합한 가치투자의 집대성", cat: "Strategy" },
    { index: 35, topic: "찰리 멍거: 버핏의 파트너, 위대한 기업을 적정가에 사서 장기 보유하는 전략 완성", cat: "Strategy" },
    { index: 36, topic: "피터 린치: '생활 속 기업 발굴' 및 마젤란 펀드의 전설적 수익률 기록", cat: "Strategy" },
    { index: 37, topic: "세스 클라만: 안전진폭(Margin of Safety)을 극도로 중시하는 현대 가치투자의 거장", cat: "Strategy" },
    { index: 38, topic: "존 템플턴: 비관론이 극에 달했을 때 남들이 버린 주식을 담는 역발상 투자 개척", cat: "Strategy" },
    { index: 39, topic: "제시 리버모어: 추세매매, 손절매, 피보팅 포인트 등 현대 데이트레이딩의 전설", cat: "Strategy" },
    { index: 40, topic: "윌리엄 오닐: 차트 패턴(컵 위드 핸들)과 실적을 결합한 CAN SLIM 전략 정립", cat: "Strategy" },
    { index: 41, topic: "리처드 데니스: 규칙 기반 추세추종 시스템을 가르친 '터틀 트레이딩' 창시자", cat: "Strategy" },
    { index: 42, topic: "래리 위리엄스: 변동성 돌파 전략 및 Williams %R 지표 개발", cat: "Strategy" },
    { index: 43, topic: "마크 미네르비니: 차트의 변동성 축소 패턴(VCP)을 정립한 현대 실전 트레이딩 거장", cat: "Strategy" },
    { index: 44, topic: "에드 세이코타: 1970년대 최초로 전산화된 컴퓨터 추세추종 매매 시스템 도입", cat: "Strategy" },
    { index: 45, topic: "짐 사이먼스: 르네상스 테크놀로지를 설립, 수학 모델 기반 '퀀트 투자' 시대 정립", cat: "Quant" },
    { index: 46, topic: "켄 그리핀: 시타델 설립자, 초고속 알고리즘 및 초단타 매매(HFT)로 유동성 지배", cat: "Quant" },
    { index: 47, topic: "에드 소프: 수리통계학을 금융에 적용하여 최초의 차익거래(Arbitrage) 펀드 운용", cat: "Quant" },
    { index: 48, topic: "조지 소로스: 주가와 현실이 서로 영향을 준다는 '재귀성 이론' 및 헤지펀드 개척", cat: "Macro" },
    { index: 49, topic: "레이 달리오: 올웨더(All-Weather) 포트폴리오 및 리스크 파리티 전략 정립", cat: "Macro" },
    { index: 50, topic: "폴 튜더 존스: 1987년 '블랙 먼데이' 증시 폭락을 예측하고 숏 포지션으로 대박을 낸 트레이더", cat: "Strategy" },
    { index: 51, topic: "스탠리 드라켄밀러: 30년간 손실 없이 거시 경제의 판을 읽고 집행한 거장", cat: "Macro" },
    { index: 52, topic: "짐 로저스: 원자재와 글로벌 인프라 주기를 분석해 투자하는 대형 스케일의 거시 투자자", cat: "Macro" },
    { index: 53, topic: "칼 아이칸: 기업 지분을 산 뒤 구조조정과 주주환원을 요구하는 '행동주의 투자' 대부", cat: "Strategy" },
    { index: 54, topic: "마이클 버리: 2008년 서브프라임 모기지 사태를 예측해 주택시장 붕괴에 숏을 건 '빅쇼트'의 실제 인물", cat: "Macro" },
    { index: 55, topic: "해리 마코위츠: 현대 포트폴리오 이론(MPT) 및 수학적 분산투자 창시", cat: "Strategy" },
    { index: 56, topic: "존 보글: 세계 최초 인덱스 펀드 발명 및 저비용 패시브 투자 대중화", cat: "Global" },
    { index: 57, topic: "유진 파마: 효율적 시장 가설(EMH)을 정립하여 패시브 투자의 학술적 기반 제공", cat: "Strategy" },
    { index: 58, topic: "다니엘 카너먼: 행동경제학의 아버지, 인간의 심리적 오류(손실 회피 등) 증명", cat: "Psychology" },
    { index: 59, topic: "마크 더글라스: 《주식투자 심리학》 저자, 확률적 사고와 트레이딩 심리학 정립", cat: "Psychology" },
    { index: 60, topic: "빌 그로스: '채권의 왕', 금리 변동과 주식-채권 자산 흐름의 연계성 정립", cat: "Macro" },
    { index: 61, topic: "잭 슈웨거: 전 세계 전설적 트레이더들을 인터뷰한 《시장의 마법사들》 저자", cat: "Psychology" },
    { index: 62, topic: "전력망·변압기·SMR 부족 사태 : AI 데이터센터 열풍이 불러온 에너지 대전환", cat: "Sector" },
    { index: 63, topic: "고환율(원/달러) 고착화와 서학개미·달러 자산 투자자의 리스크 관리법", cat: "Macro" },
    { index: 64, topic: "‘코리아 디스카운트’ 해법 : 기업 밸류업 프로그램과 주주환원율의 실제 변화", cat: "Strategy" },
    { index: 65, topic: "기준금리 중립 수준 도달 이후의 채권 투자 및 장기금리 변동성 대응 전략", cat: "Macro" },
    { index: 66, topic: "반도체 슈퍼사이클 재진입과 HBM·차세대 패키징 밸류체인 진단", cat: "Sector" },
    { index: 67, topic: "K-뷰티·K-푸드·방산의 글로벌 영토 확장 : ‘수출 주도형’ 중소형주의 도약", cat: "Sector" },
    { index: 68, topic: "캐즘(일시적 수요 정체)에 빠진 전기차/배터리 산업과 하이브리드·원통형 배터리의 반격", cat: "Sector" },
    { index: 69, topic: "미국 상장기업의 자사주 매입(Buyback) 돌풍과 주가 부양 메커니즘", cat: "Global" },
    { index: 70, topic: "AI 전환(AX) 가속화와 법률·회계·금융 등 전문직 일자리 지형 변화", cat: "Tech" },
    { index: 71, topic: "부동산 프로젝트파이낸싱(PF) 구조조정과 금융권 신용스프레드 영향 분석", cat: "Macro" },
    { index: 72, topic: "가상자산(비트코인) ETF 제도화 이후 증시 자금 유출입 상관관계", cat: "Global" },
    { index: 73, topic: "S&P 500 빅테크 쏠림 현상 극복을 위한 ‘동일비중 ETF’ 및 분산투자 아이디어", cat: "Global" },
    { index: 74, topic: "기후 위기와 탄소배출권 규제가 기업 재무제표에 직접 주는 영향", cat: "Strategy" },
    { index: 75, topic: "초고령화 사회 진입과 은퇴자 자산 관리 : 배당 성장주 vs 리츠(REITs) 비교", cat: "Strategy" },
    { index: 76, topic: "공모주(IPO) 시장의 양극화 : 소형 대박주와 대어급 상장의 상장 첫날 수급 분석", cat: "Strategy" },
    { index: 77, topic: "글로벌 원자재 가격 파동과 원자력·우라늄 관련주 재평가 배경", cat: "Sector" },
    { index: 78, topic: "기관과 외국인의 ‘스마트머니’ 수급 추적을 통한 주가 신호 읽는 법", cat: "SupplyDemand" },
    { index: 79, topic: "빅테크의 CAPEX(설비투자) 상향과 잉여현금흐름 적자: AI 거품론인가, 장기 투자인가", cat: "Tech" },
    { index: 80, topic: "트럼프 행정부의 60개국 기습 관세 부과와 글로벌 공급망 타격", cat: "Macro" },
    { index: 81, topic: "중동 리스크 재확산에 따른 국제유가 급등과 원자재 관련주 수혜 분석", cat: "Sector" },
    { index: 82, topic: "미국 10년물 국채금리 4.7% 돌파: 고금리 장기화 우려 속에 살아남을 업종", cat: "Macro" },
    { index: 83, topic: "실적 호조에도 폭락한 알파벳·테슬라 사례로 보는 '눈높이 높아진 시장' 대응법", cat: "Strategy" },
    { index: 84, topic: "AI 서버 전력난 심화와 차세대 에너지(원전·SMR·액침냉각) 밸류체인 재평가", cat: "Sector" },
    { index: 85, topic: "삼성 vs 애플 폴더블 및 차세대 스마트폰 주도권 싸움과 밸류체인 영향을 받는 부품주", cat: "Sector" },
    { index: 86, topic: "인텔의 반등 신호와 데이터센터/AI 사업 매출 급증이 국내 반도체에 주는 시사점", cat: "Tech" },
    { index: 87, topic: "글로벌 헤지펀드 운용자산 사상 최대(8천조 원) 돌파: 스마트머니의 자금 이동 경로", cat: "SupplyDemand" },
    { index: 88, topic: "국고채 금리와 환율 동반 상승 속 외국인·기관 수급 변화 추적 전략", cat: "Macro" },
    { index: 89, topic: "유럽연합(EU)의 구글 규제 강화와 미·EU 통상 갈등이 테크 기업에 미치는 영향", cat: "Global" },
    { index: 90, topic: "수출 호조 속 내수 둔화, K자형 양극화 국면에서 찾는 중소형 수출주 전략", cat: "Macro" },
    { index: 91, topic: "누진 부동산세 개편 논의와 부동산 시장 수급 및 자산 시장 파급력", cat: "Macro" },
    { index: 92, topic: "에탄올·친환경 연료 전환 지연과 에너지 원자재 시장의 구조적 변화", cat: "Sector" },
    { index: 93, topic: "비트코인·솔라나 등 가상자산 시장으로의 기관 자금 유입과 증시 수급 영향", cat: "Global" },
    { index: 94, topic: "실업수당 청구 건수 감소 등 미국 고용 지표 호조가 연준(Fed) 금리 경로에 미치는 여파", cat: "Macro" },
    { index: 95, topic: "항공/방산 업계의 판버러 에어쇼 호조와 글로벌 지정학적 리스크 속 방산주 재평가", cat: "Sector" },
    { index: 96, topic: "중국의 대EU 통상 제재 맞불과 대중국 통상 비중이 높은 기업들의 리스크 점검", cat: "Global" },
    { index: 97, topic: "국내 증시 외국인 매도세 약화 신호: 레버리지 수급과 주가 바닥 확인 지표", cat: "SupplyDemand" },
    { index: 98, topic: "상장 폐지 요건 강화 이슈와 코스피/코스닥 소형주 옥석 가리기 가이드", cat: "Strategy" },
    { index: 99, topic: "M7(매그니피센트 7) 의존도 심화와 S&P 500 동일비중 ETF의 대안", cat: "Global" },
    { index: 100, topic: "미국 대선/정치 리스크와 정권별 수혜 업종 역사적 비교", cat: "Macro" },
    { index: 101, topic: "중국 경기 부양책과 중국 증시 반등의 지속 가능성", cat: "Global" },
    { index: 102, topic: "'FOMO(소외 공포)'를 극복하는 조정장 속 비중 조절 노하우", cat: "Psychology" },
    { index: 103, topic: "공모주(IPO) 시장의 대어급 상장과 '상장 첫날 스파이크' 대응법", cat: "Strategy" },
    { index: 104, topic: "배당 성장주 투자 vs 고배당 ETF : 장기 투자자를 위한 선택 기준", cat: "Strategy" },
    { index: 105, topic: "스마트머니(기관·연기금·외국인) 수급을 추적하여 승률 높이기", cat: "SupplyDemand" },
    { index: 106, topic: "비트코인 ETF 정착과 제도권 금융 진입이 증시에 미친 파급력", cat: "Global" },
    { index: 107, topic: "기후변화와 탄소배출권 시장 : ESG 2.0 시대의 주식 투자 전략", cat: "Strategy" }
  ];
    ...
    try {
      ...
      if (targetStocks.length > 0) {
        ...
        for (let i = 0; i < targetStocks.length; i++) {
          ...
          // Cool down to prevent rate limit (3500ms throttling)
...
[애드센스 SEO 최적화 및 고품질 장문(4,000자 이상) 스토리텔링 칼럼 작성 지침]
1. 페르소나 및 문체:
...
2. 필수 구성 요소 및 이야기 스토리텔링 (AdSense Premium Content):
   - **분량**: 공백 제외 최소 4,000자 이상의 압도적 볼륨과 깊이 있는 독창적 분석 내용을 채우십시오.
  ...
  app.all('/api/cron/collect-stocks', verifyCronAuth, async (req, res) => {
    try {
      ...
      for (const stock of targetStocks) {
        ...
        // Throttle 3.5 seconds between stock AI requests to prevent RPM rate limit
        await new Promise(resolve => setTimeout(resolve, 3500));
      }
    ...
    try {
      ...
      const mapped = await Promise.all((data || []).map(async row => {
        ...
        return {
          ...
          author: row.author || existingLocal?.author || 'AI 마켓 리서치',
